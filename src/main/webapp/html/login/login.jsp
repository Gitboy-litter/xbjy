...
<label>七天免登陆</label>
<input type="checkbox" class="remeberme" value="1" name="remeberme"><br><br>
<label>验证码</label>
<input type="text" class="code"  name="code">
<img id="vcode" src="/img/verifyCode" onclick="clickCode()" ><br><br>
<input type="button" value="提交" class="button"><br><br>
<a href="/html/login/register.jsp">注册</a>
</body>
</html>
